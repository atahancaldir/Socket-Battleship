...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.oppname_label = QtWidgets.QLabel(self.frame_2)
        self.oppname_label.setGeometry(QtCore.QRect(0, 0, 500, 30))
        self.oppname_label.setMouseTracking(True)
...
##################
        ...
        self.oppname_label_2 = QtWidgets.QLabel(self.frame_3)
        self.oppname_label_2.setGeometry(QtCore.QRect(0, 0, 500, 30))
        self.oppname_label_2.setMouseTracking(False)
        self.oppname_label_2.setTabletTracking(False)
        self.oppname_label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.oppname_label_2.setObjectName("oppname_label_2")
...
"border-radius:15px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.oppname_label.setText(_translate("Form", "<USERNAME>"))
        self.oppname_label_2.setText(_translate("Form", "<OPPONENT_NAME>"))
